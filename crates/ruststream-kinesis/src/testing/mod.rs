...
//!
//! [`KinesisTestBroker`] is a handler-stub transport that reproduces the crate's core routing in
...
pub use broker::{
    ConnectedKinesisTestBroker, KinesisTestBroker, KinesisTestPublish, KinesisTestPublisher,
};
